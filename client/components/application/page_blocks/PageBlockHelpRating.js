...
PageBlockHelpRating = function PageBlockHelpRating() {
    ...
    this.init = function () {
        ...
        line = 4;
        list.push({name:ElementImage, x: 100 + 100, y : 65+ rowHeight * line + offsetY, src: '/images/rating/buttonTop.png'});
        list.push({name:ElementText, width:600, x: 250 + 100, y : 65 + rowHeight * line + offsetY, text: '&larr; топ игроков.'});

        line = 4;
        list.push({name:ElementImage, x: 100 + 100, y : 95 + rowHeight * line + offsetY, src: '/images/rating/buttonMyPosition.png'});
        list.push({name:ElementText, width: 600,x: 250 + 100, y : 95 + rowHeight * line + offsetY, text: '&larr; позиция в общем рейтинге.'});

        line = 5;
        list.push({name: ElementImage, x: 100 + 100, y: 55 + rowHeight * line + offsetY, src: '/images/buttons/ratingRest.png'});
        list.push({name: ElementText, width: 600, x: 250 + 100, y: 72 + rowHeight * line + offsetY, text: '&larr; позиции лучших игроков.'});

...
PageHelpMainMenu = function PageHelpMainMenu() {
    ...
    this.init = function () {
        ...
        list.push({name: ElementText, width: 600, x: 390, y: 93 + rowHeight * line + offsetY, text: '&larr; выбор знака: любой, \r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;крестик или нолик.'});
        ...
        list.push({name: ElementText, width: 600, x: 390, y: 90 + rowHeight * line + offsetY, text: '&larr; выбор поля: 3х3 или 15х15.'});
        ...
        list.push({name: ElementText, width: 600, x: 360, y: 83 + rowHeight * line + offsetY, text: '&larr; отправить приглашение сыграть.'});
        ...
        list.push({name: ElementText, width: 600, x: 155, y: 118 + rowHeight * line + offsetY, text: '&larr; поле для оптравки сообщений в чат.'});
